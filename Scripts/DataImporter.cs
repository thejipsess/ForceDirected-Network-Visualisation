...
public class DataImporter : MonoBehaviour
{
    ...
    public string path;
    private ConnectionDataImporter script;
    ...
    void Start()
    {
        ...
        // enable the ConnectionDataImporter script on this object
        GameObject DataImportObject = GameObject.Find("DataImportObject");
        script = DataImportObject.GetComponent<ConnectionDataImporter>();
        script.enabled = true;
    }
